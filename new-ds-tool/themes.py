...
class Themes():
    def __init__(self):
        ...
        self.dragonspyre = """
            /* ==============================
            Dragonspyre Embers Theme - PyQt6
            Inspired by the fallen world, volcanic rock, and cinders.
            Font: serif (for an ancient, epic feel)
            ============================== */

            /* Base widget background */
            QWidget {
                background-color: #1C1C1E;      /* Cooled volcanic rock */
                color: #D1D1D1;                /* Ash-white text */
            ...
            /* Buttons */
            QPushButton {
                background-color: #2C2C2E;      /* Dark slate */
                color: #FFFFFF;                /* Crisp white text */
                border: 2px solid #E54B4B;      /* Molten red border */
                border-radius: 4px;             /* Sharper, cracked edges */
                padding: 6px 12px;
                font-size: 16px;
            }
            QPushButton:hover {
                background-color: #3C3C3E;      /* Lighter slate */
                border: 2px solid #FF6448;      /* Glowing ember orange */
            }
            QPushButton:pressed {
                background-color: #222224;      /* Darker pressed slate */
                border: 2px solid #C53030;      /* Smoldering red */
                color: #D1D1D1;
            }

            /* Labels */
            QLabel {
                color: #FF6448;                /* Glowing ember orange */
            ...
            QLineEdit {
                background-color: #2C2C2E;      /* Dark slate inlay */
                color: #D1D1D1;
                border: 1px solid #555555;      /* Grey ash outline */
                border-radius: 4px;
                padding: 4px;
            }
            QLineEdit:focus {
                border: 2px solid #E54B4B;      /* Focused molten red glow */
            ...
            /* Scrollbars */
            QScrollBar:vertical {
                background: #1C1C1E;           /* Volcanic rock */
                width: 12px;
                margin: 0px;
            }
            QScrollBar::handle:vertical {
                background: #E54B4B;           /* Molten red handle */
                border-radius: 6px;
                min-height: 20px;
            }
            QScrollBar::handle:vertical:hover {
                background: #FF6448;           /* Brighter ember */
            }
            ...
            QProgressBar::chunk {
                background-color: #E54B4B;      /* Solid molten red chunk */
                border-radius: 6px;
            }
        """
